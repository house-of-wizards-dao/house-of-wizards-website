            ...
            <main className="flex-1 max-w-7xl mx-auto w-full px-4 sm:px-6 lg:px-8 py-8">
              ...
              <div className="text-center mb-12 animate-fade-in">
                ...
                <p className="text-neutral-400 text-lg max-w-2xl mx-auto">
                  Set up your profile, showcase your art, and join our magical
                  community
                </p>
              </div>
                        ...
                        {files.length > 0 && (
                          <div className="flex items-center gap-3">
                            <div className="bg-brand-500/20 text-brand-400 px-4 py-2 rounded-xl border border-brand-500/30 text-sm font-medium">
                              {files.length}{" "}
                              {files.length === 1 ? "artwork" : "artworks"}
                            </div>
                          </div>
                        )}
                      </div>
                        ...
                        {files.length === 0 ? (
                          <div className="flex flex-col items-center justify-center h-full text-center py-16">
                            ...
                            <p className="text-neutral-400 max-w-sm">
                              Upload your first magical creation to start
