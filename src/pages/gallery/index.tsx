          ...
          {isVideo ? (
            ...
            >
              <LazyImage
                ...
                fallback={
                  <div className="w-full h-[65vh] bg-gray-800 rounded-xl flex items-center justify-center animate-pulse">
                    <div className="w-16 h-16 border-4 border-brand-500 border-t-transparent rounded-full animate-spin" />
                  </div>
                }
                errorFallback={
                  <div className="w-full h-[65vh] bg-gray-800 border-2 border-dashed border-gray-600 rounded-xl flex items-center justify-center">
        ...
        <div className="relative aspect-square overflow-hidden">
          {isVideo ? (
            ...
            <LazyImage
              ...
              threshold={0.1}
              fallback={
                <div className="w-full h-full bg-gradient-to-br from-brand-900/20 to-brand-800/20 flex items-center justify-center">
                  <div className="w-8 h-8 border-2 border-brand-500 border-t-transparent rounded-full animate-spin" />
                </div>
              }
              errorFallback={
                <div className="w-full h-full bg-gray-800 border-2 border-dashed border-brand-700 flex items-center justify-center">
                  <div className="text-center">
                    <svg
                      className="w-8 h-8 text-brand-600 mx-auto mb-2"
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                    >
