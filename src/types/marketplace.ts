 ...
 */
export type MarketplaceNFT = OpenSeaNFT & {
  traits?: NFTTrait[];
  owner?: string;
  rarity_rank?: number;
};
 ...
 */
export type MarketplaceBrowserState = {
  collection: CollectionKey;
 ...
 * Format ETH from wei
 */
export const formatEthFromWei = (wei: string | undefined | null): string => {
  if (!wei) return "0";
