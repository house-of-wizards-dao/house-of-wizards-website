...
export function useImageUpload(): UseImageUploadReturn {
  ...
  const uploadImage = useCallback(async (options: UploadOptions = {}): Promise<string | null> => {
    if (!selectedImage) {
    ...
    try {
      ...
      if (options.thumbnailSize) formData.append('thumbnailSize', options.thumbnailSize.toString());
