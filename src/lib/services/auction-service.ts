...
export class AuctionService {
  ...
  async createArtwork(
    ...
    if (error) {
      logger.error(
        ...
        createDatabaseErrorContext(error, "insert", "artworks", {
          artistId: data.artist_id,
          title: data.title,
        }),
      );
  ...
  async updateArtwork(
    ...
    if (error) {
      logger.error(
        ...
        createDatabaseErrorContext(error, "update", "artworks", {
          artworkId: id,
        }),
      );
  ...
  async getArtwork(id: string): Promise<Artwork | null> {
    ...
    if (error) {
      ...
      logger.error(
        ...
        createDatabaseErrorContext(error, "select", "artworks", {
          artworkId: id,
        }),
      );
  ...
  async createAuction(
    ...
    if (error) {
      logger.error(
        ...
        createDatabaseErrorContext(error, "insert", "auctions", {
          artworkId: data.artwork_id,
  ...
  async updateAuction(
    ...
    if (error) {
      logger.error(
        ...
        createDatabaseErrorContext(error, "update", "auctions", {
          auctionId: id,
        }),
      );
  ...
  async getAuction(id: string): Promise<Auction | null> {
    ...
    if (error) {
      ...
      logger.error(
        ...
        createDatabaseErrorContext(error, "select", "auctions", {
          auctionId: id,
        }),
      );
  ...
  private async searchDatabaseAuctions(
    ...
    if (error) {
      logger.error(
        "Error searching auctions",
        createDatabaseErrorContext(error, "select", "auctions", { params }),
      );
  ...
  private async searchSmartContractAuctions(
    ...
    try {
      ...
      logger.warn(
        "Failed to fetch smart contract auctions",
  ...
  async getAuctionWithContract(id: string): Promise<Auction | null> {
    ...
    if (id.startsWith("contract-auction-")) {
      try {
        ...
        logger.error(
          "Failed to fetch smart contract auction",
          createLogContext(error),
        );
        return null;
      }
  ...
  async placeBid(
    ...
    if (error) {
      logger.error(
        "Error placing bid",
        createDatabaseErrorContext(error, "insert", "bids", {
  ...
  async getCurrentWinningBid(auctionId: string): Promise<Bid | null> {
    ...
    if (error) {
      if (error.code === "PGRST116") return null;
      logger.error(
        "Error fetching current winning bid",
        createDatabaseErrorContext(error, "select", "bids", { auctionId }),
      );
      return null;
    }
  ...
  async getUserBids(
    ...
    if (error) {
      logger.error(
        ...
        createDatabaseErrorContext(error, "select", "bids", { userId }),
      );
  ...
  async addToWatchlist(
    ...
    if (error) {
      ...
      logger.error(
        ...
        createDatabaseErrorContext(error, "insert", "auction_watchlist", {
          auctionId,
          userId,
        }),
      );
  ...
  async removeFromWatchlist(userId: string, auctionId: string): Promise<void> {
    ...
    if (error) {
      logger.error(
        ...
        createDatabaseErrorContext(error, "delete", "auction_watchlist", {
          auctionId,
          userId,
        }),
      );
  ...
  async getUserWatchlist(userId: string): Promise<WatchlistItem[]> {
    ...
    if (error) {
      logger.error(
        ...
        createDatabaseErrorContext(error, "select", "auction_watchlist", {
          userId,
        }),
      );
  ...
  private async updateAuctionBidInfo(auctionId: string): Promise<void> {
    ...
    if (error) {
      logger.error(
        "Error updating auction bid info",
        createDatabaseErrorContext(error, "update", "auctions", { auctionId }),
      );
    }
  }
  ...
  private async getRecentBidsByUser(
    ...
    if (error) {
      logger.error(
        "Error fetching recent bids",
        createDatabaseErrorContext(error, "select", "bids", {
          userId,
          seconds,
        }),
      );
  ...
  async getAuctionBids(
    ...
    if (auctionId.startsWith("contract-auction-")) {
      try {
        ...
        logger.error(
          "Failed to fetch smart contract auction bids",
          createLogContext(error),
        );
  ...
  async trackAuctionView(
    ...
    try {
      ...
      logger.error(
        "Error tracking auction view",
        createLogContext(error, { auctionId, userId }),
      );
  ...
  async deleteAuction(id: string, userId: string): Promise<void> {
    ...
    if (error) {
      logger.error(
        ...
        createDatabaseErrorContext(error, "delete", "auctions", {
          auctionId: id,
        }),
      );
  ...
  async searchArtworks(params: {
    ...
    if (error) {
      logger.error(
        "Error searching artworks",
        createDatabaseErrorContext(error, "select", "artworks", { params }),
      );
  ...
  async hasActiveAuctions(artworkId: string): Promise<boolean> {
    ...
    if (error) {
      logger.error(
        "Error checking active auctions",
        createDatabaseErrorContext(error, "select", "auctions", { artworkId }),
      );
      return false;
    }
  ...
  async deleteArtwork(id: string, userId: string): Promise<void> {
    ...
    if (error) {
      logger.error(
        ...
        createDatabaseErrorContext(error, "delete", "artworks", {
          artworkId: id,
        }),
      );
