  ...
  return (
    <div className="flex flex-col gap-4 md:sticky top-0 z-10 bg-background/95 backdrop-blur-sm py-4 border-b border-neutral-800 mb-4 w-full">
      <div className="flex justify-center items-center gap-4">
        <label htmlFor="forged-with-filter" className="text-sm font-medium text-gray-300">
        ...
        <select
          ...
          className="px-4 py-2 bg-neutral-800 border border-neutral-700 rounded-lg text-sm text-white focus:outline-none focus:ring-2 focus:ring-brand-500 focus:border-transparent"
        >
