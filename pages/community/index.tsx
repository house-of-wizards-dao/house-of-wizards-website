  ...
  return (
    <DefaultLayout>
      <div className="flex flex-col items-center gap-4 max-w-8xl h-screen">
        <h1 className="sm:text-7xl text-6xl font-atirose text-violet">
          Community
        </h1>
        ...
        <div className="max-w-7xl flex flex-col gap-6 sm:p-0 p-4">
          <p className="text-md text-center">
            ...
            <i className="font-atirose text-xl text-violet">Forgoten Runes</i>{" "}
            token holders. The{" "}
            <i className="font-atirose text-xl text-violet">Beast Spawn</i> and{" "}
            <i className="font-atirose text-xl text-violet">
          ...
          <p className="text-md text-center">
            ...
            <i className="font-atirose text-xl text-violet">talent</i>!
          </p>
        </div>
      </div>
    </DefaultLayout>
