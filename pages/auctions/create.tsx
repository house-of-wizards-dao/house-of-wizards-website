...
import { Upload, ImageIcon, Calendar, DollarSign, Clock, Info } from "lucide-react";
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!formData.start_immediately && formData.scheduled_start_date) {
        const scheduledDateTime = new Date(`${formData.scheduled_start_date}T${formData.scheduled_start_time || '00:00'}`);
      ...
      const auctionData = {
        ...
        reserve_price: formData.has_reserve ? parseFloat(formData.reserve_price) : null,
      ...
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-300 text-lg max-w-2xl mx-auto">
            List your artwork for auction and let collectors bid on your unique creations.
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
                    ...
                    <div className={`border-2 border-dashed rounded-xl p-8 text-center transition-colors ${
                      ...
                      {artworkPreview ? (
                        <div className="space-y-4">
                          ...
                          <p className="text-violet text-sm">Click to change artwork</p>
                        </div>
                      ) : (
                        <div className="space-y-4">
                          <Upload size={48} className="mx-auto text-gray-400" />
                          <div>
                            <p className="text-white font-medium">Upload your artwork</p>
                      ...
                      <Dropdown>
                        <DropdownTrigger>
                          <Button className="w-full justify-start bg-background/50 border border-darkviolet text-white hover:border-violet">
                            {categories.find(c => c.key === formData.category)?.label || 'Select Category'}
                          </Button>
                        </DropdownTrigger>
                        <DropdownMenu
                          aria-label="Category selection"
                          selectedKeys={[formData.category]}
                          onSelectionChange={(keys) => updateFormData('category', Array.from(keys)[0])}
                        >
              ...
              <Card className="border border-darkviolet bg-transparent/50 backdrop-blur-sm">
                ...
                <CardBody className="space-y-4">
                  <Input
                    ...
                    onChange={(e) => updateFormData('starting_bid', e.target.value)}
                    required
                  />
                  ...
                  <Input
                    ...
                    onChange={(e) => updateFormData('minimum_increment', e.target.value)}
                    required
                  />
                  ...
                  <div className="space-y-3">
                    <Switch
                      ...
                      onValueChange={(checked) => updateFormData('has_reserve', checked)}
                    >
                ...
                <CardBody>
                  <div className="space-y-2">
                      ...
                      <DropdownTrigger>
                        <Button className="w-full justify-start bg-background/50 border border-darkviolet text-white hover:border-violet">
                          {(() => {
                            ...
                            return durations[formData.duration_hours as keyof typeof durations] || 'Select Duration';
                          })()}
                        </Button>
                      </DropdownTrigger>
                      <DropdownMenu
                        ...
                        onSelectionChange={(keys) => updateFormData('duration_hours', Array.from(keys)[0])}
                      >
                    ...
                    <p className="text-xs text-gray-400">
                      Auction will start immediately and run for the selected duration
                    </p>
                  </div>
                </CardBody>
              </Card>
                ...
                <CardBody className="space-y-3">
                  <div className="flex items-start space-x-3">
                    ...
                    <div className="text-sm space-y-2">
                      <p className="text-blue-200 font-medium">Auction Guidelines</p>
                      <ul className="text-blue-300 space-y-1 text-xs">
                        <li>• Auctions start immediately upon creation</li>
                        <li>• Bids placed in the last 5 minutes extend the auction</li>
          ...
          <div className="flex justify-center space-x-4">
            ...
            <Button
              ...
              disabled={!artworkFile || !formData.title || !formData.starting_bid}
